    ...
    <div>
      ...
      <div className="content">
        ...
        <p>
          ...
          seus membros fundadores e seguidos com honra por todos que vestem
          nosso colete: Família, Honra, Lealdade, Liberdade, Respeito, Irmandade
          e Igualdade
        </p>
        <h2 className="title-icon">Código de Conduta</h2>
        <ul>
          <li>
            Proteger, respaldar e ajudar qualquer irmão do motoclube é questão
            de ordem.
          </li>
